...
async function resolve(opts) {
    ...
    if (wantsCsfle && !download.csfle) {
        throw new Error(`No CSFLE library download for version ${version === null || version === void 0 ? void 0 : version.version} available ${util_1.inspect(opts)}`);
    }
    debug('fully resolved', JSON.stringify(opts, null, 2), download);
    let { url } = wantsCsfle
        ? download.csfle
        : ((_a = (wantsCryptd ? download.cryptd : null)) !== null && _a !== void 0 ? _a : download.archive);
    if (wantsCryptd) {
